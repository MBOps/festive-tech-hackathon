...
# Geographies are used to deploy all regions to Terraform, commented out regions are Azure regions that require access requests which are not granted by default. 
